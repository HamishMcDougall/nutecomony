...
export default function Main() {
  ...
  const projectInfoPeanutz = {
    ...
    projectDescription: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard Lorem Ipsum is simply dummy text of the printing  Lorem Ipsum is simply dummy text of the printing and typesetting industry. ", 
  ...
  return (
    <>
      ...
      <Container fluid style={{ marginTop:"20px",  padding:"50px" , backgroundColor:"#0D3B66" }} >
        ...
        <hr />
        <Text>Copyright © 2022 nutecomony. All Rights Reserved.</Text>
        </Flex>
      </Container>
    </>
  );
